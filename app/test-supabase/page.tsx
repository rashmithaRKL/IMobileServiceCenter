...
export default function TestSupabasePage() {
  ...
  useEffect(() => {
    ...
    console.log('NEXT_PUBLIC_SUPABASE_URL:', url || '❌ undefined')
    console.log('NEXT_PUBLIC_SUPABASE_ANON_KEY:', key ? '✅ Loaded (hidden)' : '❌ undefined')
          ...
          {(!envStatus.url || !envStatus.key) && (
            <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded">
              ...
              <ul className="list-disc list-inside mt-2 text-sm text-yellow-600 space-y-1">
                ...
                <li>Add <code className="bg-yellow-500/20 px-1 rounded">NEXT_PUBLIC_SUPABASE_URL</code> and <code className="bg-yellow-500/20 px-1 rounded">NEXT_PUBLIC_SUPABASE_ANON_KEY</code></li>
