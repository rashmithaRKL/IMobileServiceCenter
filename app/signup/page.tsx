...
export default function SignUpPage() {
  ...
  const showSignupCaptchaUI = process.env.NEXT_PUBLIC_SHOW_SIGNUP_CAPTCHA_UI === "true"
  const enforceSignupCaptcha = process.env.NEXT_PUBLIC_ENFORCE_SIGNUP_CAPTCHA === "true"
